...
public class MinesweeperServer {
    ...
    public void serve() throws IOException {
        while (true) {
            ...
            numPlayers++;
            new Thread(new MinesweeperServerRunnable(socket, board, this)).start();
        }
    }
    ...
    public static Board getBoardFromFile(File file) throws IOException {
        Board b;
        String line;
        String[] tokens;
            ...
            while ((line = br.readLine()) != null) {
                ...
                for (int i = 0; i < tokens.length; i++) {
                    if (Integer.parseInt(tokens[i]) == 1) {
                        b.setBomb(i, rowNumber, true);
                    } else if (Integer.parseInt(tokens[i]) == 0) {
                        b.setBomb(i, rowNumber, false);
                    } else {
                        throw new RuntimeException();
                    }
                }
